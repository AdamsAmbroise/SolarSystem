...
function animate() {
    ...
    function incrementCounter(nbAn, nbMois, nbJour) {
        ...
        var nbHeures = TimeSpeed[currentIndex][3];
        var nbMinutes = TimeSpeed[currentIndex][4];
        var nbSecondes = TimeSpeed[currentIndex][5];
        counter = counter + ((365.25 * nbAn) 
                            + (30 * nbMois) 
                            + nbJour 
                            + ( nbHeures / 24) 
                            + ( nbMinutes / (24 * 60)) 
                            + ( nbSecondes / (24 * 60 * 60))) / 20;
        console.log('nbAn : ' + nbAn);
        console.log('nbMois : ' + nbMois);
        console.log('nbJour : ' + nbJour);
        console.log('nbHeures : ' + nbHeures);
        console.log('nbMinutes : ' + nbMinutes);
        console.log('nbSecondes : ' + nbSecondes);
