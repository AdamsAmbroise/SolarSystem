function init() {
    ...
    function LoadPlanets() {
        ...
        mercure = new Planets('Mercure', 1, 0.09758, 0.005, 5.79, 0xe39600, 88, 1.02, 0.98, 35);
        venus = new Planets('Venus', 2, 0.24508, 0.002, 10.82, 0xff7f00, 225, 0.99, 1.01, 150);
        earth = new Planets('Earth', 3, 0.2612, 0.001, 14.96, 0x0000ff, 365.25, 1.02, 0.98, 0);
        moon = new Planets('Moon', 10, 0.1, 0.003, 1.5, 0xffffff, 27.3, 1.01, 0.99, 4);
        ...
        europa = new Planets('Europa', 12, 0.2, 0.006, 9, 0xffffff, 3.6, 1.01, 0.99, 1);
        ganymede = new Planets('Ganymede', 13, 0.4, 0.004, 12, 0xffffff, 7.2, 1.01, 0.99, 5);
        callisto = new Planets('Callisto', 14, 0.4, 0.002, 15, 0xffffff, 16.7, 1.01, 0.99, 2 );
        saturne = new Planets('Saturne', 6, 2.41072, 0.0004, 143.2, 0xa19a79, 10747, 1.001, 0.999, 1200);
        uranus = new Planets('Uranus', 7, 1.82236, 0.0003, 286.7, 0x6e96e3, 30589, 1.001, 0.999, 50000);
        neptune = new Planets('Neptune', 8, 0.99056, 0.0001, 451.5, 0x1e4be3, 59800, 1.001, 0.999, 650000);
    ...
    function LoadTextures() {
        ...
        const textureSpa = textureLoader.load('./textures/space.jpg', function (textureSpa) {
